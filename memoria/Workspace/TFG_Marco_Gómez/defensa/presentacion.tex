...
\begin{frame}{Elección alg. de optimización caja negra}
    \begin{table}
        \centering
        \small
        \begin{tabular}{l *{3}{>{\centering\arraybackslash}m{2.6cm}}}
            \toprule
    ...
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{50 muestras iniciales + 350 iteraciones = 400 evals.} $\to$ \textbf{suficiente} dada la dimensionalidad (9) y \textbf{no excesivo}
                \item Estabilización de $4000$\,ms y \textbf{eval.} y observación de $7000$\,ms ($\boldsymbol{\sim 5}$ \textbf{\textit{bursts}}). Mucho, pero no hay que esperar eso realmente
    ...
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Estabilización de $\boldsymbol{400}$\,\textbf{ms} y \textbf{eval.} de $\boldsymbol{1800}$\,\textbf{ms} ($\boldsymbol{\sim 1}$ \textbf{periodo de \textit{burst}}). \textbf{Tiempo real}
...
\begin{frame}{Conclusiones}
    ...
    \begin{itemize}
        ...
        \item \textbf{Función de eval.} (forma + rango de corriente) que orienta \textbf{eficazmente} la búsqueda
...
\begin{frame}{Limitaciones y trabajo futuro}
    ...
    \begin{itemize}
        ...
        \item Funciones de eval. \textbf{con información temporal más fina}
