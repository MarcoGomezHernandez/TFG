...
apt-get -y upgrade
apt-get -y install \
	autotools-dev automake libtool gcc g++ gdb fakeroot \
	...
	qtbase5-dev qttools5-dev-tools qttools5-dev libhdf5-dev \
...
echo "-----> Installing qwt..."
if apt-cache show libqwt-qt5-dev > /dev/null 2>&1; then
